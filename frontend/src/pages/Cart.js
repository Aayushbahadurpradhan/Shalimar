                    ...
                    <div className='mt-5 lg:mt-0 w-full max-w-sm'>
                        {loading ? (
                            ...
                            <div className='h-36 bg-white'>
                                ...
                                <button className='border border-red-600 text-red-600 hover:bg-red-600 hover:text-white w-1/2 mx-auto my-2 p-1 flex justify-center items-center' onClick={handlePayment}>Checkout</button>
                            </div>
                        )}
                    </div>
                )}
