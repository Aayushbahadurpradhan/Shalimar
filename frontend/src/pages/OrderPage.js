                    ...
                    data.map((item, index) => {
                        return (
                            <div key={item.userId + index}>
                                ...
                                <div className='flex flex-col lg:flex-roww justify-between'>
                                <div className='grid gap-1'>
                                    {
                                        item?.productDetails.map((product, index) => {
                                            return (
                                                <div key={product.productId + index} className='fle gap-3 bg-slate-100'>
                                ...
                                <div className='flex felx-col lg:flex-row gap-4 p-2'>
                                    <div>
